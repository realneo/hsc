...
<ul class="nav navbar-top-links navbar-right">
   ...
   <?php if($this->session->userdata('auth_type')<=30){//from 30:Managers going down to 10:Admin can change it?>
    <li class="dropdown">
...
<li class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-user">
        ...
        <?php if($this->session->userdata('auth_type')==23 or $this->session->userdata('auth_type')==30 or $this->session->userdata('auth_type')<=20){//21:accountant 23 - Operations 30: -manager >20 management){?>
            <li class="divider"></li>
