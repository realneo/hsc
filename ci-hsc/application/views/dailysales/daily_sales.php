...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header"><?php if($this->session->userdata('branch_name')) echo $this->session->userdata('branch_name');else "General" ?> Daily Sales <span class='small'><?php $date = date("Y-m-d"); echo custom_date_format($date)?></span></h4>
