        ...
        <div class='col-lg-4'>
			...
			<form action="<?php echo base_url('admin/daily_sales_edit');?>" method='post'>
                <div class="input-group">
                    ...
                    <input class='form-control money' type='text' name='total_sale' placeholder="<?php echo $today_sales; ?>"/>
                    <span class="input-group-btn"><button class="btn btn-primary" type="submit">Edit</button></span>
                </div>
            </form>
            </div>
